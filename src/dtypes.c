...
tk_fp16_t tk_float_to_fp16(float f) { return tk__fp16_from_float(f); }
...
tk_f8_t tk_float_to_f8(float f) { return tk__f8_from_float(f); }
...
int         tk_elems_per_byte(void) { return TK_ELEMS_PER_BYTE; }
